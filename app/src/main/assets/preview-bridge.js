...
window.ArkforgeNative={
 bootstrap(){return ok({product:'Faithbook',version:'19.0.0-foundation-preview',runtime:'browser-preview',stats:{db_integrity:'PREVIEW',records:load().filter(x=>!x.archived).length,projects:0,managed_files:0,corpus_files:0,cantus_events:0},projects:[],features:{mode:'preview'}})},
