...
public class NativeBridge {
    ...
    @JavascriptInterface public String mirrorSummary(){try{return db.mirrorSummary().toString();}catch(Exception e){return MainActivity.error(e.getMessage()).toString();}}
    @JavascriptInterface public String mirrorSearch(String q,String disposition,int limit){try{JSONObject o=new JSONObject();o.put("ok",true);o.put("results",db.mirrorSearch(q,disposition,limit));return o.toString();}catch(Exception e){return MainActivity.error(e.getMessage()).toString();}}
    @JavascriptInterface public String mirrorSet(long fileId,String disposition,String reflection){try{db.setMirrorDisposition(fileId,disposition,reflection);return "{\"ok\":true}";}catch(Exception e){return MainActivity.error(e.getMessage()).toString();}}
    @JavascriptInterface public String mirrorSweep(boolean rescan){try{JSONObject o=MirrorFilter.sweep(activity,db,rescan);o.put("ok",true);return o.toString();}catch(Exception e){return MainActivity.error(e.getMessage()).toString();}}
    @JavascriptInterface public String importAllAccessible(){try{boolean granted=activity.hasAllFilesAccess();activity.requestImportAll();JSONObject o=new JSONObject();o.put("ok",true);o.put("pending",true);o.put("all_files_access",granted);return o.toString();}catch(Exception e){return MainActivity.error(e.getMessage()).toString();}}
    @JavascriptInterface public String allFilesAccessStatus(){try{JSONObject o=new JSONObject();o.put("ok",true);o.put("granted",activity.hasAllFilesAccess());o.put("scope","shared storage plus previously authorized document-provider trees");return o.toString();}catch(Exception e){return MainActivity.error(e.getMessage()).toString();}}
