...
m=re.search(r"versionCode\s+(\d+)",grad);c("V24+ code",bool(m) and int(m.group(1))>=240001);c("V24 Home Base lineage",any(x in grad for x in ["homebase-phone-intake","unified-core","full-continuity","import-all"]))
